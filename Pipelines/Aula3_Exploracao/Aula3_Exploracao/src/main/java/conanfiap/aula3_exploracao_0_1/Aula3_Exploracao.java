...
package conanfiap.aula3_exploracao_0_1;
...
/**
 * Job: Aula3_Exploracao Purpose: Exportar base para o time de Data Science<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Aula3_Exploracao implements TalendJob {
...
public String getDirectoryPath(){
	...
	private final String jobName = "Aula3_Exploracao";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Aula3_Exploracao.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Aula3_Exploracao.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:NaPhEe7ho0eHHG1psIceXAoHogtNGZHLJe371g==");
...
public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
    final static byte[] commonByteArrayLock_CONANFIAP_Aula3_Exploracao = new byte[0];
    static byte[] commonByteArray_CONANFIAP_Aula3_Exploracao = new byte[0];
			    ...
			    public Double Store_AnnualSales;

				public Double getStore_AnnualSales () {
					return this.Store_AnnualSales;
				}
				
			    public Double Store_AnnualRevenue;

				public Double getStore_AnnualRevenue () {
					return this.Store_AnnualRevenue;
				}
				
			    public String Store_BankName;

				public String getStore_BankName () {
					return this.Store_BankName;
				}
				
			    public String Store_BusinessType;

				public String getStore_BusinessType () {
					return this.Store_BusinessType;
				}
				
			    public Integer Store_YearOpened;

				public Integer getStore_YearOpened () {
					return this.Store_YearOpened;
				}
				
			    public String Store_Specialty;

				public String getStore_Specialty () {
					return this.Store_Specialty;
				}
				
			    public Integer Store_SquareFeet;

				public Integer getStore_SquareFeet () {
					return this.Store_SquareFeet;
				}
				
			    public String Store_Brands;

				public String getStore_Brands () {
					return this.Store_Brands;
				}
				
			    public String Store_Internet;

				public String getStore_Internet () {
					return this.Store_Internet;
				}
				
			    public Integer Store_NumberEmployees;

				public Integer getStore_NumberEmployees () {
					return this.Store_NumberEmployees;
				}
				
			    public String Store_AddressType;

				public String getStore_AddressType () {
					return this.Store_AddressType;
				}
				
			    public String Store_AddressLine1;

				public String getStore_AddressLine1 () {
					return this.Store_AddressLine1;
				}
				
			    public String Store_AddressLine2;

				public String getStore_AddressLine2 () {
					return this.Store_AddressLine2;
				}
			    ...
			    public String Store_StateProvinceName;

				public String getStore_StateProvinceName () {
					return this.Store_StateProvinceName;
				}
				
			    public String Store_PostalCode;

				public String getStore_PostalCode () {
					return this.Store_PostalCode;
				}
				
			    public String Store_CountryRegionName;

				public String getStore_CountryRegionName () {
					return this.Store_CountryRegionName;
				}
				
			    public Double PercRNK;

				public Double getPercRNK () {
					return this.PercRNK;
				}
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONANFIAP_Aula3_Exploracao.length) {
				if(length < 1024 && commonByteArray_CONANFIAP_Aula3_Exploracao.length == 0) {
   					commonByteArray_CONANFIAP_Aula3_Exploracao = new byte[1024];
				} else {
   					commonByteArray_CONANFIAP_Aula3_Exploracao = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONANFIAP_Aula3_Exploracao, 0, length);
			strReturn = new String(commonByteArray_CONANFIAP_Aula3_Exploracao, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONANFIAP_Aula3_Exploracao) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.Store_Name = readString(dis);
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Store_AnnualSales = null;
           				} else {
           			    	this.Store_AnnualSales = dis.readDouble();
           				}
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.Store_AnnualRevenue = null;
           				} else {
           			    	this.Store_AnnualRevenue = dis.readDouble();
           				}
					
					this.Store_BankName = readString(dis);
					
					this.Store_BusinessType = readString(dis);
					
						this.Store_YearOpened = readInteger(dis);
					
					this.Store_Specialty = readString(dis);
					
						this.Store_SquareFeet = readInteger(dis);
					
					this.Store_Brands = readString(dis);
					
					this.Store_Internet = readString(dis);
					
						this.Store_NumberEmployees = readInteger(dis);
					
					this.Store_AddressType = readString(dis);
					
					this.Store_AddressLine1 = readString(dis);
					
					this.Store_AddressLine2 = readString(dis);
					
					this.Store_City = readString(dis);
					
					this.Store_StateProvinceName = readString(dis);
					
					this.Store_PostalCode = readString(dis);
					
					this.Store_CountryRegionName = readString(dis);
					
			            length = dis.readByte();
           				if (length == -1) {
           	    			this.PercRNK = null;
           				} else {
           			    	this.PercRNK = dis.readDouble();
           				}
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Double
						...
						if(this.Store_AnnualSales == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.Store_AnnualSales);
		            	}
					
					// Double
				
						if(this.Store_AnnualRevenue == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.Store_AnnualRevenue);
		            	}
					
					// String
				
						writeString(this.Store_BankName,dos);
					
					// String
				
						writeString(this.Store_BusinessType,dos);
					
					// Integer
				
						writeInteger(this.Store_YearOpened,dos);
					
					// String
				
						writeString(this.Store_Specialty,dos);
					
					// Integer
				
						writeInteger(this.Store_SquareFeet,dos);
					
					// String
				
						writeString(this.Store_Brands,dos);
					
					// String
				
						writeString(this.Store_Internet,dos);
					
					// Integer
				
						writeInteger(this.Store_NumberEmployees,dos);
					
					// String
				
						writeString(this.Store_AddressType,dos);
					
					// String
				
						writeString(this.Store_AddressLine1,dos);
					
					// String
				
						writeString(this.Store_AddressLine2,dos);
					
					// String
				
						writeString(this.Store_City,dos);
					
					// String
				
						writeString(this.Store_StateProvinceName,dos);
					
					// String
				
						writeString(this.Store_PostalCode,dos);
					
					// String
				
						writeString(this.Store_CountryRegionName,dos);
					
					// Double
				
						if(this.PercRNK == null) {
			                dos.writeByte(-1);
						} else {
               				dos.writeByte(0);
           			    	dos.writeDouble(this.PercRNK);
		            	}
    ...
    public String toString() {
		...
		sb.append(",Store_AnnualSales="+String.valueOf(Store_AnnualSales));
		sb.append(",Store_AnnualRevenue="+String.valueOf(Store_AnnualRevenue));
		sb.append(",Store_BankName="+Store_BankName);
		sb.append(",Store_BusinessType="+Store_BusinessType);
		sb.append(",Store_YearOpened="+String.valueOf(Store_YearOpened));
		sb.append(",Store_Specialty="+Store_Specialty);
		sb.append(",Store_SquareFeet="+String.valueOf(Store_SquareFeet));
		sb.append(",Store_Brands="+Store_Brands);
		sb.append(",Store_Internet="+Store_Internet);
		sb.append(",Store_NumberEmployees="+String.valueOf(Store_NumberEmployees));
		sb.append(",Store_AddressType="+Store_AddressType);
		sb.append(",Store_AddressLine1="+Store_AddressLine1);
		sb.append(",Store_AddressLine2="+Store_AddressLine2);
		sb.append(",Store_City="+Store_City);
		sb.append(",Store_StateProvinceName="+Store_StateProvinceName);
		sb.append(",Store_PostalCode="+Store_PostalCode);
		sb.append(",Store_CountryRegionName="+Store_CountryRegionName);
		sb.append(",PercRNK="+String.valueOf(PercRNK));
	    sb.append("]");
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Talend/9ABD_Conan/Relatorios/Aula3_Exploracao/Treino_Exploracao_DataScience.csv")).getAbsolutePath().replace("\\","/");
    ...
    globalMap.put("tFileOutputDelimited_1_FILE_NAME",fileName_tFileOutputDelimited_1);
                String[] headColutFileOutputDelimited_1=new String[87];
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[46]="Product_Name";
                                    headColutFileOutputDelimited_1[47]="Product_Number";
                                    headColutFileOutputDelimited_1[48]="Product_MakeFlag";
                                    headColutFileOutputDelimited_1[49]="Product_FinishedGoodsFlag";
                                    headColutFileOutputDelimited_1[50]="Product_Color";
                                    headColutFileOutputDelimited_1[51]="Product_SafetyStockLevel";
                                    headColutFileOutputDelimited_1[52]="Product_ReorderPoint";
                                    headColutFileOutputDelimited_1[53]="Product_StandardCost";
                                    headColutFileOutputDelimited_1[54]="Product_ListPrice";
                                    headColutFileOutputDelimited_1[55]="Product_Size";
                                    headColutFileOutputDelimited_1[56]="Product_SizeUnitMeasureName";
                                    headColutFileOutputDelimited_1[57]="Product_Weight";
                                    headColutFileOutputDelimited_1[58]="Product_WeightUnitMeasureName";
                                    headColutFileOutputDelimited_1[59]="Product_DaysToManufacture";
                                    headColutFileOutputDelimited_1[60]="Product_Line";
                                    headColutFileOutputDelimited_1[61]="Product_Class";
                                    headColutFileOutputDelimited_1[62]="Product_Style";
                                    headColutFileOutputDelimited_1[63]="Product_SellStartDate";
                                    headColutFileOutputDelimited_1[64]="Product_SellEndDate";
                                    headColutFileOutputDelimited_1[65]="Product_DiscontinuedDate";
                                    headColutFileOutputDelimited_1[66]="Product_SubCategory";
                                    headColutFileOutputDelimited_1[67]="Product_Category";
                                    headColutFileOutputDelimited_1[68]="Product_Model";
                                    headColutFileOutputDelimited_1[69]="Store_Name";
                                    headColutFileOutputDelimited_1[70]="Store_AnnualSales";
                                    headColutFileOutputDelimited_1[71]="Store_AnnualRevenue";
                                    headColutFileOutputDelimited_1[72]="Store_BankName";
                                    headColutFileOutputDelimited_1[73]="Store_BusinessType";
                                    headColutFileOutputDelimited_1[74]="Store_YearOpened";
                                    headColutFileOutputDelimited_1[75]="Store_Specialty";
                                    headColutFileOutputDelimited_1[76]="Store_SquareFeet";
                                    headColutFileOutputDelimited_1[77]="Store_Brands";
                                    headColutFileOutputDelimited_1[78]="Store_Internet";
                                    headColutFileOutputDelimited_1[79]="Store_NumberEmployees";
                                    headColutFileOutputDelimited_1[80]="Store_AddressType";
                                    headColutFileOutputDelimited_1[81]="Store_AddressLine1";
                                    headColutFileOutputDelimited_1[82]="Store_AddressLine2";
                                    headColutFileOutputDelimited_1[83]="Store_City";
                                    headColutFileOutputDelimited_1[84]="Store_StateProvinceName";
                                    headColutFileOutputDelimited_1[85]="Store_PostalCode";
                                    headColutFileOutputDelimited_1[86]="Store_CountryRegionName";
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("C:/Talend/9ABD_Conan/Relatorios/Aula3_Exploracao/Teste_Exploracao_DataScience.csv")).getAbsolutePath().replace("\\","/");
    ...
    globalMap.put("tFileOutputDelimited_2_FILE_NAME",fileName_tFileOutputDelimited_2);
                String[] headColutFileOutputDelimited_2=new String[87];
            ...
            csvSettings_tFileOutputDelimited_2.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_2.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_2.length()==0){
                                    ...
                                    headColutFileOutputDelimited_2[1]="Sales_RevisionNumber";
                                    headColutFileOutputDelimited_2[2]="Sales_OrderDate";
                                    headColutFileOutputDelimited_2[3]="Sales_DueDate";
                                    headColutFileOutputDelimited_2[4]="Sales_ShipDate";
                                    headColutFileOutputDelimited_2[5]="Sales_Status";
                                    headColutFileOutputDelimited_2[6]="Sales_OnlineOrderFlag";
                                    headColutFileOutputDelimited_2[7]="Sales_SalesOrderNumber";
                                    headColutFileOutputDelimited_2[8]="Sales_PurchaseOrderNumber";
                                    headColutFileOutputDelimited_2[9]="Sales_AccountNumber";
                                    headColutFileOutputDelimited_2[10]="Sales_CustomerID";
                                    headColutFileOutputDelimited_2[11]="SalesPersonID";
                                    headColutFileOutputDelimited_2[12]="Sales_TerritoryID";
                                    headColutFileOutputDelimited_2[13]="Sales_BillToAddressID";
                                    headColutFileOutputDelimited_2[14]="Sales_ShipToAddressID";
                                    headColutFileOutputDelimited_2[15]="Sales_ShipMethodID";
                                    headColutFileOutputDelimited_2[16]="Sales_CreditCardID";
                                    headColutFileOutputDelimited_2[17]="Sales_CreditCardApprovalCode";
                                    headColutFileOutputDelimited_2[18]="Sales_CurrencyRateID";
                                    headColutFileOutputDelimited_2[19]="Sales_SubTotal";
                                    headColutFileOutputDelimited_2[20]="Sales_TaxAmt";
                                    headColutFileOutputDelimited_2[21]="Sales_Freight";
                                    headColutFileOutputDelimited_2[22]="Sales_TotalDue";
                                    headColutFileOutputDelimited_2[23]="Sales_Comment";
                                    headColutFileOutputDelimited_2[24]="SalesOrderDetailID";
                                    headColutFileOutputDelimited_2[25]="Sales_CarrierTrackingNumber";
                                    headColutFileOutputDelimited_2[26]="Sales_OrderQty";
                                    headColutFileOutputDelimited_2[27]="Sales_ProductID";
                                    headColutFileOutputDelimited_2[28]="Sales_SpecialOfferID";
                                    headColutFileOutputDelimited_2[29]="Sales_UnitPrice";
                                    headColutFileOutputDelimited_2[30]="Sales_UnitPriceDiscount";
                                    headColutFileOutputDelimited_2[31]="Sales_LineTotal";
                                    headColutFileOutputDelimited_2[32]="SP_TerritoryID";
                                    headColutFileOutputDelimited_2[33]="SalesQuota";
                                    headColutFileOutputDelimited_2[34]="Bonus";
                                    headColutFileOutputDelimited_2[35]="CommissionPct";
                                    headColutFileOutputDelimited_2[36]="SalesYTD";
                                    headColutFileOutputDelimited_2[37]="SalesLastYear";
                                    headColutFileOutputDelimited_2[38]="SP_PersonType";
                                    headColutFileOutputDelimited_2[39]="SP_FirstName";
                                    headColutFileOutputDelimited_2[40]="SP_MiddleName";
                                    headColutFileOutputDelimited_2[41]="SP_LastName";
                                    headColutFileOutputDelimited_2[42]="SP_Suffix";
                                    headColutFileOutputDelimited_2[43]="SP_EmailPromotion";
                                    headColutFileOutputDelimited_2[44]="SP_AdditionalContactInfo";
                                    headColutFileOutputDelimited_2[45]="SP_Demographics";
                                    headColutFileOutputDelimited_2[46]="Product_Name";
                                    headColutFileOutputDelimited_2[47]="Product_Number";
                                    headColutFileOutputDelimited_2[48]="Product_MakeFlag";
                                    headColutFileOutputDelimited_2[49]="Product_FinishedGoodsFlag";
                                    headColutFileOutputDelimited_2[50]="Product_Color";
                                    headColutFileOutputDelimited_2[51]="Product_SafetyStockLevel";
                                    headColutFileOutputDelimited_2[52]="Product_ReorderPoint";
                                    headColutFileOutputDelimited_2[53]="Product_StandardCost";
                                    headColutFileOutputDelimited_2[54]="Product_ListPrice";
                                    headColutFileOutputDelimited_2[55]="Product_Size";
                                    headColutFileOutputDelimited_2[56]="Product_SizeUnitMeasureName";
                                    headColutFileOutputDelimited_2[57]="Product_Weight";
                                    headColutFileOutputDelimited_2[58]="Product_WeightUnitMeasureName";
                                    headColutFileOutputDelimited_2[59]="Product_DaysToManufacture";
                                    headColutFileOutputDelimited_2[60]="Product_Line";
                                    headColutFileOutputDelimited_2[61]="Product_Class";
                                    headColutFileOutputDelimited_2[62]="Product_Style";
                                    headColutFileOutputDelimited_2[63]="Product_SellStartDate";
                                    headColutFileOutputDelimited_2[64]="Product_SellEndDate";
                                    headColutFileOutputDelimited_2[65]="Product_DiscontinuedDate";
                                    headColutFileOutputDelimited_2[66]="Product_SubCategory";
                                    headColutFileOutputDelimited_2[67]="Product_Category";
                                    headColutFileOutputDelimited_2[68]="Product_Model";
                                    headColutFileOutputDelimited_2[69]="Store_Name";
                                    headColutFileOutputDelimited_2[70]="Store_AnnualSales";
                                    headColutFileOutputDelimited_2[71]="Store_AnnualRevenue";
                                    headColutFileOutputDelimited_2[72]="Store_BankName";
                                    headColutFileOutputDelimited_2[73]="Store_BusinessType";
                                    headColutFileOutputDelimited_2[74]="Store_YearOpened";
                                    headColutFileOutputDelimited_2[75]="Store_Specialty";
                                    headColutFileOutputDelimited_2[76]="Store_SquareFeet";
                                    headColutFileOutputDelimited_2[77]="Store_Brands";
                                    headColutFileOutputDelimited_2[78]="Store_Internet";
                                    headColutFileOutputDelimited_2[79]="Store_NumberEmployees";
                                    headColutFileOutputDelimited_2[80]="Store_AddressType";
                                    headColutFileOutputDelimited_2[81]="Store_AddressLine1";
                                    headColutFileOutputDelimited_2[82]="Store_AddressLine2";
                                    headColutFileOutputDelimited_2[83]="Store_City";
                                    headColutFileOutputDelimited_2[84]="Store_StateProvinceName";
                                    headColutFileOutputDelimited_2[85]="Store_PostalCode";
                                    headColutFileOutputDelimited_2[86]="Store_CountryRegionName";
...
+"FROM\n	Sales.SalesOrderHeader a\nINNER JOIN\n	Sales.SalesOrderDetail b\n	ON a.SalesOrderID = b.SalesOrderID";
            ...
            row1.PercRNK = rs_tDBInput_4.getDouble(1);
            ...
            row1.SalesOrderID = rs_tDBInput_4.getInt(2);
            if(rs_tDBInput_4.wasNull()){
            ...
            row1.RevisionNumber = rs_tDBInput_4.getShort(3);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row1.OrderDate = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 4);
			...
			row1.DueDate = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 5);
			...
			row1.ShipDate = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 6);
            ...
            row1.Status = rs_tDBInput_4.getShort(7);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.OnlineOrderFlag = rs_tDBInput_4.getBoolean(8);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.CustomerID = rs_tDBInput_4.getInt(12);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.SalesPersonID = rs_tDBInput_4.getInt(13);
            if(rs_tDBInput_4.wasNull()){
                    row1.SalesPersonID = null;
            }
		                    }
            ...
            row1.TerritoryID = rs_tDBInput_4.getInt(14);
            if(rs_tDBInput_4.wasNull()){
                    row1.TerritoryID = null;
            }
		                    }
            ...
            row1.BillToAddressID = rs_tDBInput_4.getInt(15);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.ShipToAddressID = rs_tDBInput_4.getInt(16);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.ShipMethodID = rs_tDBInput_4.getInt(17);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.CreditCardID = rs_tDBInput_4.getInt(18);
            if(rs_tDBInput_4.wasNull()){
                    row1.CreditCardID = null;
            }
		                    }
            ...
            row1.CurrencyRateID = rs_tDBInput_4.getInt(20);
            if(rs_tDBInput_4.wasNull()){
                    row1.CurrencyRateID = null;
            }
		                    }
            ...
            row1.SubTotal = rs_tDBInput_4.getDouble(21);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.TaxAmt = rs_tDBInput_4.getDouble(22);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.Freight = rs_tDBInput_4.getDouble(23);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.TotalDue = rs_tDBInput_4.getDouble(24);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(25).toUpperCase(java.util.Locale.ENGLISH))) {
            ...
            row1.rowguid = rs_tDBInput_4.getObject(26);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
			...
			row1.ModifiedDate = mssqlGTU_tDBInput_4.getDate(rsmd_tDBInput_4, rs_tDBInput_4, 27);
            ...
            row1.SalesOrderDetailID = rs_tDBInput_4.getInt(28);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.OrderQty = rs_tDBInput_4.getShort(30);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.ProductID = rs_tDBInput_4.getInt(31);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.SpecialOfferID = rs_tDBInput_4.getInt(32);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.UnitPrice = rs_tDBInput_4.getDouble(33);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.UnitPriceDiscount = rs_tDBInput_4.getDouble(34);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.LineTotal = rs_tDBInput_4.getDouble(35);
            if(rs_tDBInput_4.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.SalesPersonID = row1.SalesPersonID ;
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.SalesPersonID = '" + row2HashKey.SalesPersonID + "'");
								} // G 071
...
out_DataExploration_tmp.Store_Name = row2.Name ;
out_DataExploration_tmp.Store_AnnualSales = row2.AnnualSales ;
out_DataExploration_tmp.Store_AnnualRevenue = row2.AnnualRevenue ;
out_DataExploration_tmp.Store_BankName = row2.BankName ;
out_DataExploration_tmp.Store_BusinessType = row2.BusinessType ;
out_DataExploration_tmp.Store_YearOpened = row2.YearOpened ;
out_DataExploration_tmp.Store_Specialty = row2.Specialty ;
out_DataExploration_tmp.Store_SquareFeet = row2.SquareFeet ;
out_DataExploration_tmp.Store_Brands = row2.Brands ;
out_DataExploration_tmp.Store_Internet = row2.Internet ;
out_DataExploration_tmp.Store_NumberEmployees = row2.NumberEmployees ;
out_DataExploration_tmp.Store_AddressType = row2.AddressType ;
out_DataExploration_tmp.Store_AddressLine1 = row2.AddressLine1 ;
out_DataExploration_tmp.Store_AddressLine2 = row2.AddressLine2 ;
out_DataExploration_tmp.Store_City = row2.City ;
out_DataExploration_tmp.Store_StateProvinceName = row2.StateProvinceName ;
out_DataExploration_tmp.Store_PostalCode = row2.PostalCode ;
out_DataExploration_tmp.Store_CountryRegionName = row2.CountryRegionName ;
out_DataExploration_tmp.PercRNK = row1.PercRNK ;
...
if(out_DataExploration != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
            ope_tFilterRow_1.matches((out_DataExploration.PercRNK == null? false : out_DataExploration.PercRNK.compareTo(ParserUtils.parseTo_Double(String.valueOf(0.8))) < 0)
                           , "PercRNK.compareTo(0.8) < 0 failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row5 == null){ 
               ...
               row5.Store_Name = out_DataExploration.Store_Name;
               row5.Store_AnnualSales = out_DataExploration.Store_AnnualSales;
               row5.Store_AnnualRevenue = out_DataExploration.Store_AnnualRevenue;
               row5.Store_BankName = out_DataExploration.Store_BankName;
               row5.Store_BusinessType = out_DataExploration.Store_BusinessType;
               row5.Store_YearOpened = out_DataExploration.Store_YearOpened;
               row5.Store_Specialty = out_DataExploration.Store_Specialty;
               row5.Store_SquareFeet = out_DataExploration.Store_SquareFeet;
               row5.Store_Brands = out_DataExploration.Store_Brands;
               row5.Store_Internet = out_DataExploration.Store_Internet;
               row5.Store_NumberEmployees = out_DataExploration.Store_NumberEmployees;
               row5.Store_AddressType = out_DataExploration.Store_AddressType;
               row5.Store_AddressLine1 = out_DataExploration.Store_AddressLine1;
               row5.Store_AddressLine2 = out_DataExploration.Store_AddressLine2;
               row5.Store_City = out_DataExploration.Store_City;
               row5.Store_StateProvinceName = out_DataExploration.Store_StateProvinceName;
               row5.Store_PostalCode = out_DataExploration.Store_PostalCode;
               row5.Store_CountryRegionName = out_DataExploration.Store_CountryRegionName;
               row5.PercRNK = out_DataExploration.PercRNK;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row6 == null){
              row6 = new row6Struct();
            }
                row6.SalesOrderID = out_DataExploration.SalesOrderID;
                row6.Sales_RevisionNumber = out_DataExploration.Sales_RevisionNumber;
                row6.Sales_OrderDate = out_DataExploration.Sales_OrderDate;
                row6.Sales_DueDate = out_DataExploration.Sales_DueDate;
                row6.Sales_ShipDate = out_DataExploration.Sales_ShipDate;
                row6.Sales_Status = out_DataExploration.Sales_Status;
                row6.Sales_OnlineOrderFlag = out_DataExploration.Sales_OnlineOrderFlag;
                row6.Sales_SalesOrderNumber = out_DataExploration.Sales_SalesOrderNumber;
                row6.Sales_PurchaseOrderNumber = out_DataExploration.Sales_PurchaseOrderNumber;
                row6.Sales_AccountNumber = out_DataExploration.Sales_AccountNumber;
                row6.Sales_CustomerID = out_DataExploration.Sales_CustomerID;
                row6.SalesPersonID = out_DataExploration.SalesPersonID;
                row6.Sales_TerritoryID = out_DataExploration.Sales_TerritoryID;
                row6.Sales_BillToAddressID = out_DataExploration.Sales_BillToAddressID;
                row6.Sales_ShipToAddressID = out_DataExploration.Sales_ShipToAddressID;
                row6.Sales_ShipMethodID = out_DataExploration.Sales_ShipMethodID;
                row6.Sales_CreditCardID = out_DataExploration.Sales_CreditCardID;
                row6.Sales_CreditCardApprovalCode = out_DataExploration.Sales_CreditCardApprovalCode;
                row6.Sales_CurrencyRateID = out_DataExploration.Sales_CurrencyRateID;
                row6.Sales_SubTotal = out_DataExploration.Sales_SubTotal;
                row6.Sales_TaxAmt = out_DataExploration.Sales_TaxAmt;
                row6.Sales_Freight = out_DataExploration.Sales_Freight;
                row6.Sales_TotalDue = out_DataExploration.Sales_TotalDue;
                row6.Sales_Comment = out_DataExploration.Sales_Comment;
                row6.SalesOrderDetailID = out_DataExploration.SalesOrderDetailID;
                row6.Sales_CarrierTrackingNumber = out_DataExploration.Sales_CarrierTrackingNumber;
                row6.Sales_OrderQty = out_DataExploration.Sales_OrderQty;
                row6.Sales_ProductID = out_DataExploration.Sales_ProductID;
                row6.Sales_SpecialOfferID = out_DataExploration.Sales_SpecialOfferID;
                row6.Sales_UnitPrice = out_DataExploration.Sales_UnitPrice;
                row6.Sales_UnitPriceDiscount = out_DataExploration.Sales_UnitPriceDiscount;
                row6.Sales_LineTotal = out_DataExploration.Sales_LineTotal;
                row6.SP_TerritoryID = out_DataExploration.SP_TerritoryID;
                row6.SalesQuota = out_DataExploration.SalesQuota;
                row6.Bonus = out_DataExploration.Bonus;
                row6.CommissionPct = out_DataExploration.CommissionPct;
                row6.SalesYTD = out_DataExploration.SalesYTD;
                row6.SalesLastYear = out_DataExploration.SalesLastYear;
                row6.SP_PersonType = out_DataExploration.SP_PersonType;
                row6.SP_FirstName = out_DataExploration.SP_FirstName;
                row6.SP_MiddleName = out_DataExploration.SP_MiddleName;
                row6.SP_LastName = out_DataExploration.SP_LastName;
                row6.SP_Suffix = out_DataExploration.SP_Suffix;
                row6.SP_EmailPromotion = out_DataExploration.SP_EmailPromotion;
                row6.SP_AdditionalContactInfo = out_DataExploration.SP_AdditionalContactInfo;
                row6.SP_Demographics = out_DataExploration.SP_Demographics;
                row6.Product_Name = out_DataExploration.Product_Name;
                row6.Product_Number = out_DataExploration.Product_Number;
                row6.Product_MakeFlag = out_DataExploration.Product_MakeFlag;
                row6.Product_FinishedGoodsFlag = out_DataExploration.Product_FinishedGoodsFlag;
                row6.Product_Color = out_DataExploration.Product_Color;
                row6.Product_SafetyStockLevel = out_DataExploration.Product_SafetyStockLevel;
                row6.Product_ReorderPoint = out_DataExploration.Product_ReorderPoint;
                row6.Product_StandardCost = out_DataExploration.Product_StandardCost;
                row6.Product_ListPrice = out_DataExploration.Product_ListPrice;
                row6.Product_Size = out_DataExploration.Product_Size;
                row6.Product_SizeUnitMeasureName = out_DataExploration.Product_SizeUnitMeasureName;
                row6.Product_Weight = out_DataExploration.Product_Weight;
                row6.Product_WeightUnitMeasureName = out_DataExploration.Product_WeightUnitMeasureName;
                row6.Product_DaysToManufacture = out_DataExploration.Product_DaysToManufacture;
                row6.Product_Line = out_DataExploration.Product_Line;
                row6.Product_Class = out_DataExploration.Product_Class;
                row6.Product_Style = out_DataExploration.Product_Style;
                row6.Product_SellStartDate = out_DataExploration.Product_SellStartDate;
                row6.Product_SellEndDate = out_DataExploration.Product_SellEndDate;
                row6.Product_DiscontinuedDate = out_DataExploration.Product_DiscontinuedDate;
                row6.Product_SubCategory = out_DataExploration.Product_SubCategory;
                row6.Product_Category = out_DataExploration.Product_Category;
                row6.Product_Model = out_DataExploration.Product_Model;
                row6.Store_Name = out_DataExploration.Store_Name;
                row6.Store_AnnualSales = out_DataExploration.Store_AnnualSales;
                row6.Store_AnnualRevenue = out_DataExploration.Store_AnnualRevenue;
                row6.Store_BankName = out_DataExploration.Store_BankName;
                row6.Store_BusinessType = out_DataExploration.Store_BusinessType;
                row6.Store_YearOpened = out_DataExploration.Store_YearOpened;
                row6.Store_Specialty = out_DataExploration.Store_Specialty;
                row6.Store_SquareFeet = out_DataExploration.Store_SquareFeet;
                row6.Store_Brands = out_DataExploration.Store_Brands;
                row6.Store_Internet = out_DataExploration.Store_Internet;
                row6.Store_NumberEmployees = out_DataExploration.Store_NumberEmployees;
                row6.Store_AddressType = out_DataExploration.Store_AddressType;
                row6.Store_AddressLine1 = out_DataExploration.Store_AddressLine1;
                row6.Store_AddressLine2 = out_DataExploration.Store_AddressLine2;
                row6.Store_City = out_DataExploration.Store_City;
                row6.Store_StateProvinceName = out_DataExploration.Store_StateProvinceName;
                row6.Store_PostalCode = out_DataExploration.Store_PostalCode;
                row6.Store_CountryRegionName = out_DataExploration.Store_CountryRegionName;
                row6.PercRNK = out_DataExploration.PercRNK;
...
if(row5 != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[87];
                            ...
                            rowtFileOutputDelimited_1[46]=row5.Product_Name == null ? null : row5.Product_Name;
                            rowtFileOutputDelimited_1[47]=row5.Product_Number == null ? null : row5.Product_Number;
                            rowtFileOutputDelimited_1[48]=String.valueOf(row5.Product_MakeFlag);
                            rowtFileOutputDelimited_1[49]=String.valueOf(row5.Product_FinishedGoodsFlag);
                            rowtFileOutputDelimited_1[50]=row5.Product_Color == null ? null : row5.Product_Color;
                            rowtFileOutputDelimited_1[51]=String.valueOf(row5.Product_SafetyStockLevel);
                            rowtFileOutputDelimited_1[52]=String.valueOf(row5.Product_ReorderPoint);
                            rowtFileOutputDelimited_1[53]=String.valueOf(row5.Product_StandardCost);
                            rowtFileOutputDelimited_1[54]=String.valueOf(row5.Product_ListPrice);
                            rowtFileOutputDelimited_1[55]=row5.Product_Size == null ? null : row5.Product_Size;
                            rowtFileOutputDelimited_1[56]=row5.Product_SizeUnitMeasureName == null ? null : row5.Product_SizeUnitMeasureName;
                            rowtFileOutputDelimited_1[57]=row5.Product_Weight == null ? null : String.valueOf(row5.Product_Weight);
                            rowtFileOutputDelimited_1[58]=row5.Product_WeightUnitMeasureName == null ? null : row5.Product_WeightUnitMeasureName;
                            rowtFileOutputDelimited_1[59]=String.valueOf(row5.Product_DaysToManufacture);
                            rowtFileOutputDelimited_1[60]=row5.Product_Line == null ? null : row5.Product_Line;
                            rowtFileOutputDelimited_1[61]=row5.Product_Class == null ? null : row5.Product_Class;
                            rowtFileOutputDelimited_1[62]=row5.Product_Style == null ? null : row5.Product_Style;
                            rowtFileOutputDelimited_1[63]=row5.Product_SellStartDate == null ? null : String.valueOf(row5.Product_SellStartDate);
                            rowtFileOutputDelimited_1[64]=row5.Product_SellEndDate == null ? null : String.valueOf(row5.Product_SellEndDate);
                            rowtFileOutputDelimited_1[65]=row5.Product_DiscontinuedDate == null ? null : String.valueOf(row5.Product_DiscontinuedDate);
                            rowtFileOutputDelimited_1[66]=row5.Product_SubCategory == null ? null : row5.Product_SubCategory;
                            rowtFileOutputDelimited_1[67]=row5.Product_Category == null ? null : row5.Product_Category;
                            rowtFileOutputDelimited_1[68]=row5.Product_Model == null ? null : row5.Product_Model;
                            rowtFileOutputDelimited_1[69]=row5.Store_Name == null ? null : row5.Store_Name;
                            rowtFileOutputDelimited_1[70]=row5.Store_AnnualSales == null ? null : String.valueOf(row5.Store_AnnualSales);
                            rowtFileOutputDelimited_1[71]=row5.Store_AnnualRevenue == null ? null : String.valueOf(row5.Store_AnnualRevenue);
                            rowtFileOutputDelimited_1[72]=row5.Store_BankName == null ? null : row5.Store_BankName;
                            rowtFileOutputDelimited_1[73]=row5.Store_BusinessType == null ? null : row5.Store_BusinessType;
                            rowtFileOutputDelimited_1[74]=row5.Store_YearOpened == null ? null : String.valueOf(row5.Store_YearOpened);
                            rowtFileOutputDelimited_1[75]=row5.Store_Specialty == null ? null : row5.Store_Specialty;
                            rowtFileOutputDelimited_1[76]=row5.Store_SquareFeet == null ? null : String.valueOf(row5.Store_SquareFeet);
                            rowtFileOutputDelimited_1[77]=row5.Store_Brands == null ? null : row5.Store_Brands;
                            rowtFileOutputDelimited_1[78]=row5.Store_Internet == null ? null : row5.Store_Internet;
                            rowtFileOutputDelimited_1[79]=row5.Store_NumberEmployees == null ? null : String.valueOf(row5.Store_NumberEmployees);
                            rowtFileOutputDelimited_1[80]=row5.Store_AddressType == null ? null : row5.Store_AddressType;
                            rowtFileOutputDelimited_1[81]=row5.Store_AddressLine1 == null ? null : row5.Store_AddressLine1;
                            rowtFileOutputDelimited_1[82]=row5.Store_AddressLine2 == null ? null : row5.Store_AddressLine2;
                            rowtFileOutputDelimited_1[83]=row5.Store_City == null ? null : row5.Store_City;
                            rowtFileOutputDelimited_1[84]=row5.Store_StateProvinceName == null ? null : row5.Store_StateProvinceName;
                            rowtFileOutputDelimited_1[85]=row5.Store_PostalCode == null ? null : row5.Store_PostalCode;
                            rowtFileOutputDelimited_1[86]=row5.Store_CountryRegionName == null ? null : row5.Store_CountryRegionName;
...
if(row6 != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_2=new String[87];
                            rowtFileOutputDelimited_2[0]=String.valueOf(row6.SalesOrderID);
                            rowtFileOutputDelimited_2[1]=String.valueOf(row6.Sales_RevisionNumber);
                            rowtFileOutputDelimited_2[2]=row6.Sales_OrderDate == null ? null : String.valueOf(row6.Sales_OrderDate);
                            rowtFileOutputDelimited_2[3]=row6.Sales_DueDate == null ? null : String.valueOf(row6.Sales_DueDate);
                            rowtFileOutputDelimited_2[4]=row6.Sales_ShipDate == null ? null : String.valueOf(row6.Sales_ShipDate);
                            rowtFileOutputDelimited_2[5]=String.valueOf(row6.Sales_Status);
                            rowtFileOutputDelimited_2[6]=String.valueOf(row6.Sales_OnlineOrderFlag);
                            rowtFileOutputDelimited_2[7]=row6.Sales_SalesOrderNumber == null ? null : row6.Sales_SalesOrderNumber;
                            rowtFileOutputDelimited_2[8]=row6.Sales_PurchaseOrderNumber == null ? null : row6.Sales_PurchaseOrderNumber;
                            rowtFileOutputDelimited_2[9]=row6.Sales_AccountNumber == null ? null : row6.Sales_AccountNumber;
                            rowtFileOutputDelimited_2[10]=String.valueOf(row6.Sales_CustomerID);
                            rowtFileOutputDelimited_2[11]=row6.SalesPersonID == null ? null : String.valueOf(row6.SalesPersonID);
                            rowtFileOutputDelimited_2[12]=row6.Sales_TerritoryID == null ? null : String.valueOf(row6.Sales_TerritoryID);
                            rowtFileOutputDelimited_2[13]=String.valueOf(row6.Sales_BillToAddressID);
                            rowtFileOutputDelimited_2[14]=String.valueOf(row6.Sales_ShipToAddressID);
                            rowtFileOutputDelimited_2[15]=String.valueOf(row6.Sales_ShipMethodID);
                            rowtFileOutputDelimited_2[16]=row6.Sales_CreditCardID == null ? null : String.valueOf(row6.Sales_CreditCardID);
                            rowtFileOutputDelimited_2[17]=row6.Sales_CreditCardApprovalCode == null ? null : row6.Sales_CreditCardApprovalCode;
                            rowtFileOutputDelimited_2[18]=row6.Sales_CurrencyRateID == null ? null : String.valueOf(row6.Sales_CurrencyRateID);
                            rowtFileOutputDelimited_2[19]=String.valueOf(row6.Sales_SubTotal);
                            rowtFileOutputDelimited_2[20]=String.valueOf(row6.Sales_TaxAmt);
                            rowtFileOutputDelimited_2[21]=String.valueOf(row6.Sales_Freight);
                            rowtFileOutputDelimited_2[22]=String.valueOf(row6.Sales_TotalDue);
                            rowtFileOutputDelimited_2[23]=row6.Sales_Comment == null ? null : row6.Sales_Comment;
                            rowtFileOutputDelimited_2[24]=String.valueOf(row6.SalesOrderDetailID);
                            rowtFileOutputDelimited_2[25]=row6.Sales_CarrierTrackingNumber == null ? null : row6.Sales_CarrierTrackingNumber;
                            rowtFileOutputDelimited_2[26]=String.valueOf(row6.Sales_OrderQty);
                            rowtFileOutputDelimited_2[27]=String.valueOf(row6.Sales_ProductID);
                            rowtFileOutputDelimited_2[28]=String.valueOf(row6.Sales_SpecialOfferID);
                            rowtFileOutputDelimited_2[29]=String.valueOf(row6.Sales_UnitPrice);
                            rowtFileOutputDelimited_2[30]=String.valueOf(row6.Sales_UnitPriceDiscount);
                            rowtFileOutputDelimited_2[31]=String.valueOf(row6.Sales_LineTotal);
                            rowtFileOutputDelimited_2[32]=row6.SP_TerritoryID == null ? null : String.valueOf(row6.SP_TerritoryID);
                            rowtFileOutputDelimited_2[33]=row6.SalesQuota == null ? null : String.valueOf(row6.SalesQuota);
                            rowtFileOutputDelimited_2[34]=String.valueOf(row6.Bonus);
                            rowtFileOutputDelimited_2[35]=String.valueOf(row6.CommissionPct);
                            rowtFileOutputDelimited_2[36]=String.valueOf(row6.SalesYTD);
                            rowtFileOutputDelimited_2[37]=String.valueOf(row6.SalesLastYear);
                            rowtFileOutputDelimited_2[38]=row6.SP_PersonType == null ? null : row6.SP_PersonType;
                            rowtFileOutputDelimited_2[39]=row6.SP_FirstName == null ? null : row6.SP_FirstName;
                            rowtFileOutputDelimited_2[40]=row6.SP_MiddleName == null ? null : row6.SP_MiddleName;
                            rowtFileOutputDelimited_2[41]=row6.SP_LastName == null ? null : row6.SP_LastName;
                            rowtFileOutputDelimited_2[42]=row6.SP_Suffix == null ? null : row6.SP_Suffix;
                            rowtFileOutputDelimited_2[43]=String.valueOf(row6.SP_EmailPromotion);
                            rowtFileOutputDelimited_2[44]=row6.SP_AdditionalContactInfo == null ? null : row6.SP_AdditionalContactInfo;
                            rowtFileOutputDelimited_2[45]=row6.SP_Demographics == null ? null : row6.SP_Demographics;
                            rowtFileOutputDelimited_2[46]=row6.Product_Name == null ? null : row6.Product_Name;
                            rowtFileOutputDelimited_2[47]=row6.Product_Number == null ? null : row6.Product_Number;
                            rowtFileOutputDelimited_2[48]=String.valueOf(row6.Product_MakeFlag);
                            rowtFileOutputDelimited_2[49]=String.valueOf(row6.Product_FinishedGoodsFlag);
                            rowtFileOutputDelimited_2[50]=row6.Product_Color == null ? null : row6.Product_Color;
                            rowtFileOutputDelimited_2[51]=String.valueOf(row6.Product_SafetyStockLevel);
                            rowtFileOutputDelimited_2[52]=String.valueOf(row6.Product_ReorderPoint);
                            rowtFileOutputDelimited_2[53]=String.valueOf(row6.Product_StandardCost);
                            rowtFileOutputDelimited_2[54]=String.valueOf(row6.Product_ListPrice);
                            rowtFileOutputDelimited_2[55]=row6.Product_Size == null ? null : row6.Product_Size;
                            rowtFileOutputDelimited_2[56]=row6.Product_SizeUnitMeasureName == null ? null : row6.Product_SizeUnitMeasureName;
                            rowtFileOutputDelimited_2[57]=row6.Product_Weight == null ? null : String.valueOf(row6.Product_Weight);
                            rowtFileOutputDelimited_2[58]=row6.Product_WeightUnitMeasureName == null ? null : row6.Product_WeightUnitMeasureName;
                            rowtFileOutputDelimited_2[59]=String.valueOf(row6.Product_DaysToManufacture);
                            rowtFileOutputDelimited_2[60]=row6.Product_Line == null ? null : row6.Product_Line;
                            rowtFileOutputDelimited_2[61]=row6.Product_Class == null ? null : row6.Product_Class;
                            rowtFileOutputDelimited_2[62]=row6.Product_Style == null ? null : row6.Product_Style;
                            rowtFileOutputDelimited_2[63]=row6.Product_SellStartDate == null ? null : String.valueOf(row6.Product_SellStartDate);
                            rowtFileOutputDelimited_2[64]=row6.Product_SellEndDate == null ? null : String.valueOf(row6.Product_SellEndDate);
                            rowtFileOutputDelimited_2[65]=row6.Product_DiscontinuedDate == null ? null : String.valueOf(row6.Product_DiscontinuedDate);
                            rowtFileOutputDelimited_2[66]=row6.Product_SubCategory == null ? null : row6.Product_SubCategory;
                            rowtFileOutputDelimited_2[67]=row6.Product_Category == null ? null : row6.Product_Category;
                            rowtFileOutputDelimited_2[68]=row6.Product_Model == null ? null : row6.Product_Model;
                            rowtFileOutputDelimited_2[69]=row6.Store_Name == null ? null : row6.Store_Name;
                            rowtFileOutputDelimited_2[70]=row6.Store_AnnualSales == null ? null : String.valueOf(row6.Store_AnnualSales);
                            rowtFileOutputDelimited_2[71]=row6.Store_AnnualRevenue == null ? null : String.valueOf(row6.Store_AnnualRevenue);
                            rowtFileOutputDelimited_2[72]=row6.Store_BankName == null ? null : row6.Store_BankName;
                            rowtFileOutputDelimited_2[73]=row6.Store_BusinessType == null ? null : row6.Store_BusinessType;
                            rowtFileOutputDelimited_2[74]=row6.Store_YearOpened == null ? null : String.valueOf(row6.Store_YearOpened);
                            rowtFileOutputDelimited_2[75]=row6.Store_Specialty == null ? null : row6.Store_Specialty;
                            rowtFileOutputDelimited_2[76]=row6.Store_SquareFeet == null ? null : String.valueOf(row6.Store_SquareFeet);
                            rowtFileOutputDelimited_2[77]=row6.Store_Brands == null ? null : row6.Store_Brands;
                            rowtFileOutputDelimited_2[78]=row6.Store_Internet == null ? null : row6.Store_Internet;
                            rowtFileOutputDelimited_2[79]=row6.Store_NumberEmployees == null ? null : String.valueOf(row6.Store_NumberEmployees);
                            rowtFileOutputDelimited_2[80]=row6.Store_AddressType == null ? null : row6.Store_AddressType;
                            rowtFileOutputDelimited_2[81]=row6.Store_AddressLine1 == null ? null : row6.Store_AddressLine1;
                            rowtFileOutputDelimited_2[82]=row6.Store_AddressLine2 == null ? null : row6.Store_AddressLine2;
                            rowtFileOutputDelimited_2[83]=row6.Store_City == null ? null : row6.Store_City;
                            rowtFileOutputDelimited_2[84]=row6.Store_StateProvinceName == null ? null : row6.Store_StateProvinceName;
                            rowtFileOutputDelimited_2[85]=row6.Store_PostalCode == null ? null : row6.Store_PostalCode;
                            rowtFileOutputDelimited_2[86]=row6.Store_CountryRegionName == null ? null : row6.Store_CountryRegionName;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row3,row4,row2) outputs:(out_DataExploration)
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.SalesPersonID == null) ? 0 : this.SalesPersonID.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						if (this.SalesPersonID == null) {
							if (other.SalesPersonID != null)
								return false;
						
						} else if (!this.SalesPersonID.equals(other.SalesPersonID))
			...
			int length = 0;
			            ...
			            length = dis.readByte();
           				if (length == -1) {
           			    	...
           			    	this.AnnualSales = dis.readDouble();
           				}
						...
						this.BusinessType = readString(dis,ois);
					
						this.YearOpened = readInteger(dis,ois);
					
						this.Specialty = readString(dis,ois);
					
						this.SquareFeet = readInteger(dis,ois);
					
						this.Brands = readString(dis,ois);
					
						this.Internet = readString(dis,ois);
					
						this.NumberEmployees = readInteger(dis,ois);
						...
						this.StateProvinceName = readString(dis,ois);
					
						this.PostalCode = readString(dis,ois);
					
						this.CountryRegionName = readString(dis,ois);
        ...
        try {
						...
						if(this.AnnualSales == null) {
			                dos.writeByte(-1);
               				...
               				dos.writeByte(0);
           			    	dos.writeDouble(this.AnnualSales);
		            	}
						...
						writeString(this.BusinessType, dos, oos);
					
					writeInteger(this.YearOpened, dos, oos);
					
						writeString(this.Specialty, dos, oos);
					
					writeInteger(this.SquareFeet, dos, oos);
					
						writeString(this.Brands, dos, oos);
					
						writeString(this.Internet, dos, oos);
					
					writeInteger(this.NumberEmployees, dos, oos);
						...
						writeString(this.StateProvinceName, dos, oos);
					
						writeString(this.PostalCode, dos, oos);
					
						writeString(this.CountryRegionName, dos, oos);
    ...
    public String toString() {
		...
		sb.append(",Name="+Name);
		sb.append(",AnnualSales="+String.valueOf(AnnualSales));
		sb.append(",AnnualRevenue="+String.valueOf(AnnualRevenue));
		sb.append(",BankName="+BankName);
		sb.append(",BusinessType="+BusinessType);
		sb.append(",YearOpened="+String.valueOf(YearOpened));
		sb.append(",Specialty="+Specialty);
		sb.append(",SquareFeet="+String.valueOf(SquareFeet));
		sb.append(",Brands="+Brands);
		sb.append(",Internet="+Internet);
		sb.append(",NumberEmployees="+String.valueOf(NumberEmployees));
		sb.append(",AddressType="+AddressType);
		sb.append(",AddressLine1="+AddressLine1);
		sb.append(",AddressLine2="+AddressLine2);
		sb.append(",City="+City);
		sb.append(",StateProvinceName="+StateProvinceName);
		sb.append(",PostalCode="+PostalCode);
		sb.append(",CountryRegionName="+CountryRegionName);
		sb.append(",SalesPersonID="+String.valueOf(SalesPersonID));
	    sb.append("]");
...
+"ned\n	,a.Specialty\n	,a.SquareFeet\n	,a.Brands\n	,a.Internet\n	,a.NumberEmployees\n	,b.AddressType\n	,b.AddressLine1\n	,"
+"b.AddressLine2\n	,b.City\n	,b.StateProvinceName\n	,b.PostalCode\n	,b.CountryRegionName\n	,c.SalesPersonID\nFROM \n	[Sale"
+"s].[vStoreWithDemographics] a\nLEFT JOIN\n	[Sales].[vStoreWithAddresses] b \n	ON a.BusinessEntityID = b.BusinessEntityID"
+"\nLEFT JOIN\n	[Sales].[Store] c\n	ON a.BusinessEntityID = c.BusinessEntityID";
            ...
            row2.BusinessEntityID = rs_tDBInput_3.getInt(1);
            ...
            if(tmpContent_tDBInput_3 != null) {
                ...
                row2.Name = null;
							...
							if(colQtyInRs_tDBInput_3 < 3) {
								row2.AnnualSales = null;
							} else {
	                         		
            row2.AnnualSales = rs_tDBInput_3.getDouble(3);
            if(rs_tDBInput_3.wasNull()){
                    row2.AnnualSales = null;
            }
		                    }
							if(colQtyInRs_tDBInput_3 < 4) {
								row2.AnnualRevenue = null;
							} else {
	                         		
            row2.AnnualRevenue = rs_tDBInput_3.getDouble(4);
            if(rs_tDBInput_3.wasNull()){
                    row2.AnnualRevenue = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(5).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.BankName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.BankName = tmpContent_tDBInput_3;
                }
            } else {
                row2.BankName = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(6).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.BusinessType = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.BusinessType = tmpContent_tDBInput_3;
                }
            } else {
                row2.BusinessType = null;
            }
							...
							if(colQtyInRs_tDBInput_3 < 7) {
								row2.YearOpened = null;
							} else {
		                          
            row2.YearOpened = rs_tDBInput_3.getInt(7);
            if(rs_tDBInput_3.wasNull()){
                    row2.YearOpened = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(8).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Specialty = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.Specialty = tmpContent_tDBInput_3;
                }
            } else {
                row2.Specialty = null;
            }
							...
							if(colQtyInRs_tDBInput_3 < 9) {
								row2.SquareFeet = null;
							} else {
		                          
            row2.SquareFeet = rs_tDBInput_3.getInt(9);
            if(rs_tDBInput_3.wasNull()){
                    row2.SquareFeet = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(10).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Brands = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.Brands = tmpContent_tDBInput_3;
                }
            } else {
                row2.Brands = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(11).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Internet = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.Internet = tmpContent_tDBInput_3;
                }
            } else {
                row2.Internet = null;
            }
							...
							if(colQtyInRs_tDBInput_3 < 12) {
								row2.NumberEmployees = null;
							} else {
		                          
            row2.NumberEmployees = rs_tDBInput_3.getInt(12);
            if(rs_tDBInput_3.wasNull()){
                    row2.NumberEmployees = null;
            }
		                    }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(13).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.AddressType = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.AddressType = tmpContent_tDBInput_3;
                }
            } else {
                row2.AddressType = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(14).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.AddressLine1 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.AddressLine1 = tmpContent_tDBInput_3;
                }
            } else {
                row2.AddressLine1 = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(15).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.AddressLine2 = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.AddressLine2 = tmpContent_tDBInput_3;
                }
            } else {
                row2.AddressLine2 = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(17).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.StateProvinceName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.StateProvinceName = tmpContent_tDBInput_3;
                }
            } else {
                row2.StateProvinceName = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(18).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.PostalCode = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.PostalCode = tmpContent_tDBInput_3;
                }
            } else {
                row2.PostalCode = null;
            }
            ...
            if(tmpContent_tDBInput_3 != null) {
            	if (talendToDBList_tDBInput_3 .contains(rsmd_tDBInput_3.getColumnTypeName(19).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.CountryRegionName = FormatterUtils.formatUnwithE(tmpContent_tDBInput_3);
            	} else {
                	row2.CountryRegionName = tmpContent_tDBInput_3;
                }
            } else {
                row2.CountryRegionName = null;
            }
							...
							if(colQtyInRs_tDBInput_3 < 20) {
								row2.SalesPersonID = null;
							} else {
		                          
            row2.SalesPersonID = rs_tDBInput_3.getInt(20);
            if(rs_tDBInput_3.wasNull()){
                    row2.SalesPersonID = null;
            }
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.BusinessEntityID = row2.BusinessEntityID;
				
				row2_HashRow.Name = row2.Name;
				
				row2_HashRow.AnnualSales = row2.AnnualSales;
				
				row2_HashRow.AnnualRevenue = row2.AnnualRevenue;
				
				row2_HashRow.BankName = row2.BankName;
				
				row2_HashRow.BusinessType = row2.BusinessType;
				
				row2_HashRow.YearOpened = row2.YearOpened;
				
				row2_HashRow.Specialty = row2.Specialty;
				
				row2_HashRow.SquareFeet = row2.SquareFeet;
				
				row2_HashRow.Brands = row2.Brands;
				
				row2_HashRow.Internet = row2.Internet;
				
				row2_HashRow.NumberEmployees = row2.NumberEmployees;
				...
				row2_HashRow.StateProvinceName = row2.StateProvinceName;
				
				row2_HashRow.PostalCode = row2.PostalCode;
				
				row2_HashRow.CountryRegionName = row2.CountryRegionName;
				
				row2_HashRow.SalesPersonID = row2.SalesPersonID;
 ...
 */
    ...
    public static void main(String[] args){
        final Aula3_Exploracao Aula3_ExploracaoClass = new Aula3_Exploracao();

        int exitCode = Aula3_ExploracaoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Aula3_Exploracao.class.getClassLoader().getResourceAsStream("conanfiap/aula3_exploracao_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Aula3_Exploracao.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Aula3_Exploracao");
        }
...
/************************************************************************************************
 *     394891 characters generated by Talend Open Studio for Big Data 
 *     on the July 26, 2020 8:04:28 PM BRT
 ************************************************************************************************/