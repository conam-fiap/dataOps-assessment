...
package conanfiap.aula2_vendas_0_1;
...
/**
 * Job: Aula2_Vendas Purpose: Exportar relatório para a área de vendas<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Aula2_Vendas implements TalendJob {
...
public String getDirectoryPath(){
	...
	private final String jobName = "Aula2_Vendas";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Aula2_Vendas.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_2 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:uIoqbnQKFYJMNDlaok/+Ix8g8rye6rNhtERxdA==");
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_CONANFIAP_Aula2_Vendas = new byte[0];
    static byte[] commonByteArray_CONANFIAP_Aula2_Vendas = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CONANFIAP_Aula2_Vendas.length) {
				if(length < 1024 && commonByteArray_CONANFIAP_Aula2_Vendas.length == 0) {
   					commonByteArray_CONANFIAP_Aula2_Vendas = new byte[1024];
				} else {
   					commonByteArray_CONANFIAP_Aula2_Vendas = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CONANFIAP_Aula2_Vendas, 0, length);
			strReturn = new String(commonByteArray_CONANFIAP_Aula2_Vendas, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CONANFIAP_Aula2_Vendas) {
...
// ------------
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
	    ...
	    public boolean hashCodeDirty = true;
    				...
    				String CountryName;
    				String OnlineOrderFlag;BigDecimal TotalDue_sum;
...
+"\n  SalesOrderHeader.rowguid, \n  SalesOrderHeader.ModifiedDate\nFROM Sales.SalesOrderHeader";
            ...
            if(tmpContent_tDBInput_4 != null) {
            	if (talendToDBList_tDBInput_4 .contains(rsmd_tDBInput_4.getColumnTypeName(25).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.rowguid = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
            	} else {
                	row1.rowguid = tmpContent_tDBInput_4;
                }
            } else {
                row1.rowguid = null;
            }
 ...
 */
	...
	row4.RevisionNumber = row1.RevisionNumber;
	...
	row4.PurchaseOrderNumber = row1.PurchaseOrderNumber;

	
	row4.AccountNumber = row1.AccountNumber;

	
	row4.CustomerID = row1.CustomerID;

	
	row4.SalesPersonID = row1.SalesPersonID;
	...
	row4.ShipMethodID = row1.ShipMethodID;

	
	row4.CreditCardID = row1.CreditCardID;

	
	row4.CreditCardApprovalCode = row1.CreditCardApprovalCode;

	
	row4.CurrencyRateID = row1.CurrencyRateID;
	...
	row4.Comment = row1.Comment;

	
	row4.rowguid = row1.rowguid;

	
	row4.ModifiedDate = row1.ModifiedDate;
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Talend/9ABD_Conan/Relatorios/Aula2_Vendas/RelatorioVendas.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[4]="CountryRegionCode";
                                    headColutFileOutputDelimited_1[5]="CountryName";
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[7];
                            rowtFileOutputDelimited_1[0]=row7.OrderDate == null ? null : FormatterUtils.format_Date(row7.OrderDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_1[1]=row7.TotalDue == null ? null : row7.TotalDue.setScale(4, java.math.RoundingMode.HALF_UP).toPlainString();
                            rowtFileOutputDelimited_1[2]=row7.TerritoryName == null ? null : row7.TerritoryName;
                            rowtFileOutputDelimited_1[3]=row7.TerritoryGroup == null ? null : row7.TerritoryGroup;
                            rowtFileOutputDelimited_1[4]=row7.CountryRegionCode == null ? null : row7.CountryRegionCode;
                            rowtFileOutputDelimited_1[5]=row7.CountryName == null ? null : row7.CountryName;
                            rowtFileOutputDelimited_1[6]=row7.OnlineOrderFlag == null ? null : row7.OnlineOrderFlag;
...
row5Struct row5 = new row5Struct();
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// source node:tFilterColumns_2 - inputs:(row2) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
...
+".CostLastYear, \n  SalesTerritory.rowguid, \n  SalesTerritory.ModifiedDate\nFROM Sales.SalesTerritory";
            ...
            row2.TerritoryID = rs_tDBInput_5.getInt(1);
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row2.Name = tmpContent_tDBInput_5;
                }
            } else {
                row2.Name = null;
            }
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.CountryRegionCode = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row2.CountryRegionCode = tmpContent_tDBInput_5;
                }
            } else {
                row2.CountryRegionCode = null;
            }
            ...
            if(tmpContent_tDBInput_5 != null) {
            	if (talendToDBList_tDBInput_5 .contains(rsmd_tDBInput_5.getColumnTypeName(4).toUpperCase(java.util.Locale.ENGLISH))) {
            		row2.Group = FormatterUtils.formatUnwithE(tmpContent_tDBInput_5);
            	} else {
                	row2.Group = tmpContent_tDBInput_5;
                }
            } else {
                row2.Group = null;
            }
...
row6Struct row6 = new row6Struct();
	...
	currentComponent="tAdvancedHash_row6";
		...
		int tos_count_tAdvancedHash_row6 = 0;
			   		...
			   		// source node:tFilterColumns_3 - inputs:(row3) outputs:(row6,row6) | target node:tAdvancedHash_row6 - inputs:(row6) outputs:()
			   		// linked node: tMap_1 - inputs:(row4,row5,row6) outputs:(out_Vendas)
...
+"Region";
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(1).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.CountryRegionCode = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row3.CountryRegionCode = tmpContent_tDBInput_6;
                }
            } else {
                row3.CountryRegionCode = null;
            }
            ...
            if(tmpContent_tDBInput_6 != null) {
            	if (talendToDBList_tDBInput_6 .contains(rsmd_tDBInput_6.getColumnTypeName(2).toUpperCase(java.util.Locale.ENGLISH))) {
            		row3.Name = FormatterUtils.formatUnwithE(tmpContent_tDBInput_6);
            	} else {
                	row3.Name = tmpContent_tDBInput_6;
                }
            } else {
                row3.Name = null;
            }
 ...
 */
    ...
    public static void main(String[] args){
        final Aula2_Vendas Aula2_VendasClass = new Aula2_Vendas();

        int exitCode = Aula2_VendasClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Aula2_Vendas.class.getClassLoader().getResourceAsStream("conanfiap/aula2_vendas_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Aula2_Vendas.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Aula2_Vendas");
        }
...
/************************************************************************************************
 *     206372 characters generated by Talend Open Studio for Big Data 
 *     on the July 26, 2020 8:04:01 PM BRT
 ************************************************************************************************/